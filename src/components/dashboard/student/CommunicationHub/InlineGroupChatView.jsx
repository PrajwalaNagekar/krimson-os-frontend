...
import { ArrowLeft, Users, Send, Smile, Paperclip, CheckCheck, Check } from 'lucide-react';

const InlineGroupChatView = ({ group, onClose, onSendMessage }) => {
...
export default InlineGroupChatView;
