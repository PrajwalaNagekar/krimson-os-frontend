...
import { X, Send, Check, CheckCheck, Smile, Paperclip } from 'lucide-react';

const ReplyModal = ({ replyingTo, onClose, onSend }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fadeIn">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-3xl max-h-[85vh] overflow-hidden animate-slideUp flex flex-col">
        {/* WhatsApp-Style Header */}
        <div className="bg-gradient-to-r from-purple-500 via-pink-500 to-purple-500 p-4 text-white flex items-center justify-between">
