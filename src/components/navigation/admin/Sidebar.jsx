          ...
          <div className="mt-4 pt-3 md:pt-4 border-t border-white/20 relative z-10">
            <div className="flex items-center gap-2 md:gap-3 p-2 md:p-3 rounded-xl bg-white/10 backdrop-blur-md hover:bg-white/20 transition-colors">
              <NavLink
                ...
                className="flex items-center gap-2 md:gap-3 flex-1 group cursor-pointer"
              >
                <div className="w-7 h-7 md:w-8 md:h-8 rounded-full bg-white text-blue-600 flex items-center justify-center font-bold text-[10px] md:text-xs shadow-sm group-hover:scale-110 transition-transform flex-shrink-0">
                  A
                </div>
                <div className="flex-1 min-w-0">
                  <p className="text-xs md:text-sm font-semibold text-white group-hover:text-blue-100 transition-colors truncate">
                    Administrator
                  </p>
                  <p className="text-[9px] md:text-[10px] text-white/80">
                    :: Verified
                  </p>
                </div>
              </NavLink>
