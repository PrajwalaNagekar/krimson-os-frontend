...
import {
    ...
    LayoutDashboard, X, UserCircle, Rocket, ClipboardList, FlaskConical, Trophy, Users2, Compass,
    GraduationCap
} from 'lucide-react';
...
const Sidebar = ({ isOpen, onClose }) => {
    ...
    const menuItems = [
        ...
        { name: "Academic Planning", path: "/dashboard/teacher/academic-support", icon: <BookOpen size={20} /> }, // Combined
        { name: "Roster & Groups", path: "/dashboard/teacher/roster-groups", icon: <Users size={20} /> }, // Phase 6
        ...
        { name: "PTM Manager", path: "/dashboard/teacher/ptm", icon: <CalendarCheck size={20} /> }, // Screens 220-222
        { name: "Student Conduct", path: "/dashboard/teacher/behaviour", icon: <ClipboardList size={20} /> }, // Screen 225-227
        { name: "Exams & Tests", path: "/dashboard/teacher/tests", icon: <CheckSquare size={20} /> }, // Screen 10
        { name: "Questions & Worksheets", path: "/dashboard/teacher/assessments", icon: <PenTool size={20} /> }, // Screen 199-201
        ...
        { name: "Academic Decision", path: "/dashboard/teacher/academic-decision", icon: <GraduationCap size={20} /> }, // Screens 262-264
    ];
    ...
    return (
        <>
            ...
            {/* Sidebar Container */}
            <div className={`h-screen sidebar-width-mobile p-3 md:p-4 flex flex-col fixed left-0 top-0 z-50 transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'
                }`}>
