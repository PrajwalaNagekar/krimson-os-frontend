...
const Sidebar = ({ isOpen, onClose }) => {
    ...
    const menuItems = [
      ...
      path: "/dashboard/teacher/behaviour",
      ...
      icon: <Book size={20} />,
        ...
        {
      name: "Feedback & Reflections",
      path: "/dashboard/teacher/reflection",
      icon: <PenTool size={20} />,
    }, // Screen 13
        {
      name: "Attendance Summary",
      path: "/dashboard/teacher/attendance-summary",
    ...
    return (
      ...
      >
              ...
              >
                ...
                className="text-white hover:text-red-200 p-1.5 md:p-2 transition-colors flex-shrink-0"
              >
