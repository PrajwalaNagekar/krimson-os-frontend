...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  const menuItems = [
    {
      name: "Behavior Logs",
      path: "/dashboard/counselor/behavior",
      icon: <ClipboardList size={20} />,
    }, // Screen 1
    {
      name: "Intervention Cases",
      path: "/dashboard/counselor/cases",
      icon: <ShieldCheck size={20} />,
    }, // Screen 2
    {
      name: "Wellbeing Trends",
      path: "/dashboard/counselor/wellbeing",
      icon: <HeartPulse size={20} />,
    }, // Screen 3
    {
      name: "Collaboration Hub",
      path: "/dashboard/counselor/collaboration",
      icon: <Users size={20} />,
    }, // Screen 4
  ];
