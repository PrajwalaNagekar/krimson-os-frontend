...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  const menuItems = [
    {
      id: "admissions",
      title: "Admissions",
      path: "/dashboard/registrar/admissions",
      icon: Users,
    },
    {
      id: "records",
      title: "Student Records",
      path: "/dashboard/registrar/records",
      icon: FolderOpen,
    },
    {
      id: "compliance",
      title: "Compliance Center",
      path: "/dashboard/registrar/compliance",
      icon: AlertCircle,
    },
    {
      id: "withdrawals",
      title: "Transfers / Exits",
      path: "/dashboard/registrar/withdrawals",
      icon: LogOut,
    },
  ];
  ...
  const isActive = (path) => {
    if (
      ...
      return true;
    if (path !== "/dashboard/registrar" && location.pathname.startsWith(path))
      return true;
    return false;
  };
  ...
  return (
    <>
      ...
      {/* Sidebar Container */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-72 p-4 transition-transform duration-300 ${
