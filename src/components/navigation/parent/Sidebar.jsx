...
const Sidebar = ({ isOpen, onClose, isWideScreen }) => {
  const menuItems = [
    ...
    }, // Screen 8
    {
      ...
      path: "/dashboard/parent/behavior",
    ...
    {
      name: "Facilities",
      path: "/dashboard/parent/facilities",
      icon: <Coffee size={20} />,
    }, // New
    {
      name: "Meetings & Circles",
      path: "/dashboard/parent/meetings-circles",
    ...
    <>
      ...
      >
        ...
        <div className="h-full w-full rounded-3xl bg-gradient-to-b from-cyan-400 via-blue-400 to-pink-400 p-4 flex flex-col text-white shadow-2xl relative overflow-hidden">
          ...
          {/* Logo Area */}
          <NavLink
            to="/dashboard/parent/home"
            className="flex items-center gap-3 mb-8 pl-2 relative z-10 cursor-pointer"
          >
