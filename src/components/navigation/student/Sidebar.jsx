...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  const menuItems = [
    ...
    {
      name: "My Lab Journey",
      path: "/dashboard/student/lab-journey",
      icon: <Beaker size={20} />,
    }, // Lab Journey
    {
      name: "My Learning Support",
      path: "/dashboard/student/learning-support",
      icon: <LifeBuoy size={20} />,
    },
    {
      name: "Library Account",
      path: "/dashboard/student/library-account",
      icon: <BookOpen size={20} />,
    }, // Library Screen
    {
      name: "Facilities",
      path: "/dashboard/student/facilities",
      icon: <UtensilsCrossed size={20} />,
    }, // Facilities Screen

    {
      name: "Messages",
      path: "/dashboard/student/communication",
    ...
    {
      name: "Parent Link",
      path: "/dashboard/student/parentlink",
      icon: <Users size={20} />,
    }, // Screen 13
    {
      name: "Profile",
          ...
          <div className="mt-4 pt-3 md:pt-4 border-t border-white/20 relative z-10">
            <div className="flex items-center gap-2 md:gap-3 p-2 md:p-3 rounded-xl bg-white/10 backdrop-blur-md hover:bg-white/20 transition-colors">
              ...
              <button
                ...
                className="text-white hover:text-blue-100 p-1.5 md:p-2 transition-colors flex-shrink-0"
              >
