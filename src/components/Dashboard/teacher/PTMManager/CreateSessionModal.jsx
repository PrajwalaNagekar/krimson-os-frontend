...
const CreateSessionModal = ({ showModal, onClose, onConfirm }) => {
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-8">
            <div className="space-y-2">
              ...
              <input
                type="date"
                className="w-full p-4 bg-slate-50 border-2 border-slate-100 rounded-xl text-sm font-bold text-slate-800 focus:border-indigo-500 outline-none transition-all"
              />
            </div>
