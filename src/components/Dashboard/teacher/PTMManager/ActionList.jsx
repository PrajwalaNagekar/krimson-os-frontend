    ...
    <div className="lg:col-span-3 space-y-6">
      <div className="bg-white rounded-[3.5rem] p-10 shadow-[0_32px_128px_-16px_rgba(79,70,229,0.1)] border border-indigo-50">
        <div className="flex items-center justify-between mb-10">
          <div>
            <h2 className="text-3xl font-bold text-indigo-900 tracking-tight leading-none mb-2">
              Action Tracker
            </h2>
        ...
        <div className="space-y-4">
          {actions
            ...
            .map((action) => (
              <div
                key={action.id}
                className={`p-6 bg-white border rounded-[2rem] transition-all duration-300 relative group overflow-hidden ${
