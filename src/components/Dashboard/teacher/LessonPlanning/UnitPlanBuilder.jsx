  ...
  const [unitPlans, setUnitPlans] = useState([
    {
      ...
      objectives:
        "Students will understand the relationship between fractions and decimals, and be able to convert between them.",
      lessons: [
        {
          id: 1,
          title: "Introduction to Fractions",
          duration: "2",
          keyConcepts: "Numerator, Denominator, Proper/Improper fractions",
        },
        {
          id: 2,
          title: "Adding and Subtracting Fractions",
          duration: "2",
          keyConcepts: "Common denominators, simplification",
        },
        {
          id: 3,
          title: "Decimal Basics",
          duration: "1",
          keyConcepts: "Place value, decimal notation",
        },
        {
          id: 4,
          title: "Converting Fractions to Decimals",
          duration: "2",
          keyConcepts: "Division method, common conversions",
        },
      ],
      assessments: [
        {
        ...
        },
        {
          id: 2,
          type: "assignment",
          title: "Decimal Conversion Worksheet",
          date: "2026-02-24",
          weightage: "15",
        },
        {
      ...
      differentiation:
        "Provide visual aids for struggling students, advanced problems for high achievers",
    ...
    },
    {
      ...
      objectives:
        "Students will understand basic electrical concepts and be able to design simple circuits.",
      lessons: [
        {
          id: 1,
          title: "Introduction to Electricity",
          duration: "1",
          keyConcepts: "Charge, current, voltage",
        },
        {
          id: 2,
          title: "Ohm's Law",
          duration: "2",
          keyConcepts: "Resistance, V=IR",
        },
        {
          id: 3,
          title: "Series and Parallel Circuits",
          duration: "2",
          keyConcepts: "Circuit configurations",
        },
        {
          id: 4,
          title: "Circuit Design Lab",
          duration: "2",
          keyConcepts: "Practical application",
        },
      ],
      assessments: [
        {
        ...
        },
        {
          id: 2,
          type: "project",
          title: "Design Your Own Circuit",
          date: "2026-03-29",
          weightage: "35",
        },
      ],
      differentiation:
        "Hands-on activities for kinesthetic learners, simulation software for visual learners",
    ...
    },
    {
      ...
      objectives:
        "Students will master the use of past, present, and future tenses in writing and speaking.",
      lessons: [
        {
          id: 1,
          title: "Present Tense Review",
          duration: "1",
          keyConcepts: "Simple, continuous, perfect",
        },
        {
          id: 2,
          title: "Past Tense Forms",
          duration: "2",
          keyConcepts: "Regular/irregular verbs",
        },
        {
          id: 3,
          title: "Future Tense Usage",
          duration: "1",
          keyConcepts: "Will, going to, present continuous",
        },
        {
          id: 4,
          title: "Mixed Tense Practice",
          duration: "1",
          keyConcepts: "Context-based usage",
        },
      ],
      assessments: [
        {
        ...
        },
        {
          id: 2,
          type: "assignment",
          title: "Creative Writing - Mixed Tenses",
          date: "2026-03-01",
          weightage: "25",
        },
      ],
      differentiation:
        "Grammar games for engagement, additional examples for ESL students",
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
              ...
              <p className="opacity-90 font-medium text-sm md:text-base">
                Create detailed teaching plans for complete units •{" "}
                {unitPlans.length} Unit{unitPlans.length !== 1 ? "s" : ""}
              </p>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredPlans.map((plan) => (
          ...
          >
            ...
            <div
              className={`bg-gradient-to-r ${getSubjectColor(plan.subject)} p-6 text-white relative overflow-hidden`}
            >
              ...
              <div className="relative z-10">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <span
                    className={`px-3 py-1 rounded-lg text-xs font-bold border ${getStatusColor(plan.status)}`}
                  >
                    {plan.status}
                  </span>
                </div>
