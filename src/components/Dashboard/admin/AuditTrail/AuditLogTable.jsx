        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-slate-500">
              ...
              {Math.min(indexOfLastItem, totalItems)} of {totalItems} events
            </p>
          </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    <span
                      className={`px-2.5 py-1 rounded-lg text-xs font-bold border ${getActionColor(log.action)}`}
                    >
                      {log.action}
                    </span>
                    <span
                      className={`px-2.5 py-1 rounded-lg text-xs font-bold border ${getSeverityColor(log.severity)}`}
                    >
                      {log.severity}
                    </span>
                    {log.pdpaRelevant && (
