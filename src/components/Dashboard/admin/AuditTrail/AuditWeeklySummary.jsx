...
import { Users, Download, BarChart3, Package, TrendingUp } from "lucide-react";

const AuditWeeklySummary = ({ weeklySummary }) => {
  return (
            ...
            >
              ...
              <div className="w-full h-2 bg-slate-200 rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${
                      (user.count / weeklySummary.topUsers[0].count) * 100
                    }%`,
                  }}
                ></div>
              </div>
            ...
            >
              ...
              <div className="w-full h-2 bg-slate-200 rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${
                      (module.count / weeklySummary.topModules[0].count) * 100
                    }%`,
                  }}
                ></div>
              </div>
...
export default AuditWeeklySummary;
