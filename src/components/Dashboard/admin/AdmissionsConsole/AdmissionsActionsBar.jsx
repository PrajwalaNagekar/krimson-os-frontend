      ...
      <div className="flex gap-2 w-full md:w-auto relative">
        <div className="relative">
          <button
            ...
            className={`flex items-center gap-2 px-6 py-3 bg-slate-50 hover:bg-slate-100 text-slate-600 font-bold rounded-xl transition-colors text-sm ${
              showFilterMenu
                ? "ring-2 ring-blue-500/20 bg-blue-50 text-blue-600"
                : ""
            }`}
          >
            <Filter size={18} />
...
export default AdmissionsActionsBar;
