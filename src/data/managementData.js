...
export const ACADEMIC_OUTCOMES_DATA = {
  stats: [
    {
...
export const ADMISSIONS_GROWTH_DATA = {
  stats: [
    {
...
export const CAFETERIA_DATA = {
  ...
  grades: ["Grade 1-5", "Grade 6-10", "Grade 11-12", "Staff"],
  dietaryTags: [
    "Nut-Free",
    "Jain Friendly",
    "Dairy-Free",
  ...
  defaultMenuStructure: { Breakfast: [], Lunch: [], Snacks: [] },
};
  ...
  securityLogs: [
    {
      ...
      severity: "info",
      user: "System Admin",
      details: "Enforced 12-character minimum",
    },
    {
      date: "2024-01-19",
      ...
      severity: "warning",
      user: "Multiple Users",
      details: "15 failed attempts detected",
    },
    {
      date: "2024-01-18",
      ...
      severity: "info",
      user: "IT Admin",
      details: "Added new IP whitelist",
    },
    {
      date: "2024-01-17",
      event: "Data Encryption Verified",
      severity: "info",
      user: "System",
      details: "All databases encrypted at rest",
    },
  ],
  riskAssessment: {
...
export const INSTITUTIONAL_OVERVIEW_DATA = {
  kpiMetrics: [
    {
...
export const STRATEGIC_PLANNING_DATA = {
  stats: [
    {
...
export const TRANSPORT_DATA = {
  ...
  stops: [
    ...
    {
      id: 2,
      name: "Blue Ridge Executive Heights",
      pickup: "07:15 AM",
      drop: "04:15 PM",
      students: 5,
    },
    ...
    {
      id: 4,
      name: "Global School Metro North",
      pickup: "07:45 AM",
      drop: "03:45 PM",
      students: 15,
    },
