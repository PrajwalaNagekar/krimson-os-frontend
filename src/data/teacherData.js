  ...
  classManagement: {
    ...
    absenceManagement: {
      postponeLesson: {
        ...
        availablePeriods: [
          { id: "P3", label: "Period 3 (10:30 - 11:30)", time: "10:30" },
          { id: "P4", label: "Period 4 (11:30 - 12:30)", time: "11:30" },
          { id: "P5", label: "Period 5 (13:00 - 14:00)", time: "13:00" },
          { id: "P6", label: "Period 6 (14:00 - 15:00)", time: "14:00" },
        ],
        availabilityChecks: {
          roomAvailable: true,
          noTeacherClash: true,
          gradeConflict: "Grade 10A has Science in previous period",
        },
        notifyRecipients: ["Students", "Parents", "Admin"],
      },
      summaryRequests: [
        {
          id: "REQ-001",
...
export const GRADEBOOK_DATA = {
  ...
  // ─── CURRICULUM BUILDER ───────────────────────────────────────────────────
  curriculumBuilder: {
    // Terms defined by Coordinator (read-only reference)
    terms: [
      {
        id: "T1",
        name: "Term 1",
    ...
    // Topics created by Teacher under Chapters
    topics: [
      {
        id: "TP1",
        chapterId: "CH2",
      ...
      },
      {
        ...
        sequence: 2,
        outcomeStatement:
          "Students will apply the Fundamental Theorem of Arithmetic to real-world problems",
        outcomeCode: "MTH.10.1.2",
        bloomLevel: "Applying",
        competency: ["Knowledge", "Skill"],
        skillSubtype: ["Analysis"],
      ...
      },
      {
        ...
        sequence: 1,
        outcomeStatement:
          "Students will state and apply Euclid's Division Lemma to find HCF of two positive integers",
        outcomeCode: "MTH.10.1.0",
        bloomLevel: "Remembering",
        competency: ["Knowledge"],
        skillSubtype: [],
    ...
    config: {
      ...
      krimsonStepLabels: [
        ...
        },
        {
          ...
          label: "5. Concept Formation",
          placeholder:
            "How will the abstract concept be formally introduced...",
        },
        {
          key: "applicationTask",
          label: "6. Application Task",
