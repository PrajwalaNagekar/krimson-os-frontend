                ...
                <div className="flex items-end gap-3 mt-4">
                  ...
                  <div className="flex flex-col mb-1.5">
                    ...
                    <span className="text-green-500 text-xs font-bold flex items-center gap-0.5">
                      <TrendingUp size={12} />+{academicGrowth.percentage}%
                    </span>
                  </div>
                </div>
              </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs md:text-sm text-indigo-700/90 leading-relaxed">
                These summaries translate complex academic metrics into
                actionable insights. They help you understand not just the
                grades, but what they mean for your child's learning journey and
                where support might be most beneficial. Our AI analyzes
                patterns, trends, and contextual factors to provide personalized
                guidance.
              </p>
