        ...
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          <div className="bg-white/95 backdrop-blur-xl rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-xl border border-white/60 mb-6">
            <div className="flex items-start gap-4 mb-4">
              <div
                className={`p-4 bg-gradient-to-br ${selectedSurvey.color} rounded-2xl shadow-lg`}
              >
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-slate-500 mb-3">
                  Your feedback helps us improve. All responses are anonymized
                  and shared with management for analysis.
                </p>
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <span className="text-xs text-slate-500">
                    Deadline:{" "}
                    {new Date(selectedSurvey.deadline).toLocaleDateString(
                      "en-SG",
            ...
            <div className="flex items-start gap-3 mb-4 p-3 bg-cyan-50 border border-cyan-200 rounded-xl">
              ...
              <div className="text-xs md:text-sm text-cyan-800">
                ...
                <p>
                  ...
                  Individual responses are not shared with specific staff
                  members.
                </p>
              </div>
            </div>
