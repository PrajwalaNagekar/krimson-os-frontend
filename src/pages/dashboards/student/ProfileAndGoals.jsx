...
import {
  ...
  PermissionsTab,
  ActivityTab,
} from "../../../components/dashboard/student/Profile/ProfileSettingsTabs";
import DigitalIDModal from "../../../components/dashboard/student/Profile/DigitalIDModal";
        ...
        <div className="animate-fade-in space-y-8">
          ...
          <div className="flex flex-wrap gap-4 items-center justify-between">
            <h2 className="text-2xl font-bold text-slate-800 flex items-center gap-2">
              <Grid className="text-blue-500 fill-current opacity-20" /> My
              Portfolio
            </h2>
